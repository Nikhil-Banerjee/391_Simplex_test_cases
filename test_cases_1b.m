...
%             testCase.verifyEqual(ind,[3,4,5].', RelTol = 1e-5);
        ...
        function lecture_example(testCase)
            ...
            testCase.verifyEqual(z,-7, RelTol = 1e-5);
            testCase.verifyEqual(x,[1, 2].', RelTol = 1e-5);
            testCase.verifyEqual(pi,[0, -1].', RelTol = 1e-5);
            testCase.verifyEqual(ind,[3, 1].', RelTol = 1e-5);
            testCase.verifyEqual(exitflag,0, RelTol = 1e-5);
